          ...
          <div className="sm:col-span-2 lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-foreground/70 leading-relaxed mb-6 text-sm sm:text-base">
                Мы меняем подход к наружной рекламе с помощью передовых
                технологий ИИ: создавайте, оптимизируйте и управляйте
                кампаниями, которые дают выдающиеся результаты.
              </p>
